    ...
    for n_steps in n_inference_steps:
        for inference_lr in inference_learning_rates:
            ...
            for s in range(seeds):
                ...
                final_call = base_call + " --logdir " + str(lpath) + " --savedir " + str(spath) + " --learning_rate " + str(lr) + " --inference_learning_rate " + str(inference_lr) + " --n_inference_steps " + str(n_steps) + " --with_amortisation True --fixed_predictions False"
                print(final_call)
